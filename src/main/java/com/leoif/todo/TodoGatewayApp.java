package com.leoif.todo;

import com.leoif.todo.config.ApplicationProperties;
import com.leoif.todo.config.DefaultProfileUtil;
...
public class TodoGatewayApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TodoGatewayApp.class);

    private final Environment env;

    public TodoGatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TodoGateway.
     * <p>
